-- chunkname: @/client_locales/neededtranslations.lua
...
neededTranslations = {
	...
	"Dismount",
	"Display connection speed to the server (ping, in milliseconds) and the frame rate (FPS).",
	...
	"Hide NPCs",
	"Hide offline VIPs",
	"Hide own guild members",
	"Hide paladins",
	"Hide party members",
	"Hide players",
	"Hide players without skull",
	"Hide sorcerers",
	"Hide summons",
	...
	"Hotkey delay: %sms",
	"Hotkeys",
	"If this option is checked, a new tab will open automatically whenever you receive a private message from someone you are not already chatting with.",
	...
	"Open in new window",
	"Open new channel",
	"Open New Tabs When Receiving Private Messages",
	"Open purse",
	"Open PvP",
	"Open PvP Situations",
	"Options",
	...
	"Shielding",
	"Show all items",
	"Show connection ping and frame rate",
	"Show Depot Only",
	"Show event messages in console",
	"Show frame rate",
	"Show frame rate (same as connection ping in General).",
	"Show druids",
	...
	"Show NPCs",
	"Show offline VIPs",
	"Show own guild members",
	"Show paladins",
	"Show party members",
	"Show players",
	"Show players without skull",
