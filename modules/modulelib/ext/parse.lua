-- chunkname: @/modulelib/ext/parse.lua

local function parseAttrPropList(str)
	local obj = {}
...
local function parseStyle(widget, el)
...
local function parseLayout(widget, el)
