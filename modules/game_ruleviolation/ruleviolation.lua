...
StatementReportReasons = {
	...
	{
		id = 19,
		title = tr("Publishing clearly wrong information about Tibia"),
		description = tr("Statements can be reported if they are made to publish clearly wrong information about Tibia or its services.")
	},
	{
		id = 17,
	...
	{
		id = 19,
		title = tr("False information to Tibia"),
		description = tr("Statements can be reported if they prove that a player has intentionally given wrong or misleading information concerning rule violation reports, complaints, bug reports or support requests to Tibia.")
	},
	{
		id = 14,
	...
	{
		id = 20,
		title = tr("Attacking a Tibia Service"),
		description = tr("Statements can be reported if they prove that a player has or wants to attack, disrupt or damage the operation of Tibia servers, the game or any other part of Tibia Service.")
	},
	{
		id = 20,
	...
	{
		id = 20,
		title = tr("Violating the Tibia Service Agreement"),
		description = tr("Statements can be reported if they violate the Tibia Service Agreement or prove that the Tibia Service Agreement has been violated or is planned to be violated.")
	},
	{
		id = 20,
