...
namespace
{
    // Stage-2 resource paths. The "/assets/..." form works both when running from the working
    // directory (dev) and from the embedded assets.pak - the pak keeps files under the same prefixes.
    constexpr const char* kRectVertShaderPath = "/assets/shaders/vulkan/rect.vert.spv";
    constexpr const char* kRectFragShaderPath = "/assets/shaders/vulkan/rect.frag.spv";
    ...
    constexpr const char* kRectTexturePath = "/assets/images/clienticon.png";
