...
namespace
{
    // Resource paths. The "/assets/..." form works both when running from the working directory
    // (dev) and from the embedded assets.pak - the pak keeps files under the same prefixes.
    constexpr const char* kSpriteVertShaderPath = "/assets/shaders/vulkan/sprite.vert.spv";
    constexpr const char* kSpriteFragShaderPath = "/assets/shaders/vulkan/sprite.frag.spv";
    ...
    constexpr const char* kTestImages[] = {
        ...
        "/assets/images/back_clienticon.png",
        "/assets/images/icons_big/icon-arbitrarymonster64x64.png",
        "/assets/images/icons_big/icon_discord.png",
        "/assets/images/icons_big/icon_youtube.png",
        "/assets/images/icons_big/icon_twitch.png",
        "/assets/images/icons_big/icon_forge.png",
        "/assets/images/icons_big/icon-magicalarchive-additionalinfo.png",
        "/assets/images/icons_big/icon-magicalarchive-combatstats.png",
        "/assets/images/icons_big/icon-magicalarchive-runeinfo.png",
        "/assets/images/icons_big/icon-fusion.png",
        "/assets/images/icons_big/icon-conversion.png",
        "/assets/images/icons_big/icon-history.png",
    };
