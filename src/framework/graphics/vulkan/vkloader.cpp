...
bool VkLoader::load()
{
    ...
    g_logger.info("[vulkan] loader OK: API {}.{}.{}, instance extensions: {}",
                  VK_API_VERSION_MAJOR(m_instanceVersion),
                  VK_API_VERSION_MINOR(m_instanceVersion),
                  VK_API_VERSION_PATCH(m_instanceVersion),
